...
intergrowth_constants <- function() {
  ...
  boys_3 = c(
    ...
    0.57,0.58,0.59,0.60,0.61,0.62,0.63,0.65,0.66,0.67,0.68,0.69,0.71,
    0.72,0.73,0.75,0.76, 0.77,0.79,0.80,0.82,0.83,0.84,0.86,0.87,0.89,
    0.91,0.92,0.94,0.95,0.97,0.99,1.00,1.02, 1.04,1.06,1.08,1.09,1.11,
    1.13,1.15,1.17,1.19,1.21,1.23,1.25,1.27,1.29,1.32,1.34,1.18, 1.22,
    1.26,1.30,1.34,1.38,1.42,1.45,1.49,1.53,1.56,1.60,1.63,1.67,1.70,
    1.74,1.77,1.80, 1.83,1.87,1.90,1.93,1.96,1.99,2.02,2.05,2.08,2.11,
    2.13,2.16,2.19,2.22,2.24,2.27,2.29, 2.32,2.34,2.37,2.39,2.42,2.44,
    2.46,2.49,2.51,2.53,2.55,2.57,2.59,2.61,2.63,2.65,2.67, 2.69,2.71,
    2.73,2.75,2.76,2.78,2.80,2.82,2.83,2.85,2.86,2.88,2.89,2.91,2.92,
    2.94,2.95, 2.96
    )

  girls_3 = c(
    0.42,0.43,0.44,0.44,0.45,0.46,0.47,0.48,0.49,0.50,0.51,0.52,0.53,
...
estimate_sga_intergrowth <- function(df, include_outliers = FALSE, growth_standard = igs()) {
  ...
  sga <- factor(d[["sga"]],levels=c("0","1","2"),labels = c("AGA","SGA 3-10%", "SGA <3%"))
  return(sga)
